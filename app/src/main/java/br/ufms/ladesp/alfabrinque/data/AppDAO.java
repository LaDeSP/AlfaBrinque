package br.ufms.ladesp.alfabrinque.data;
...
import br.ufms.ladesp.alfabrinque.pojo.Categoria;
...
public class AppDAO {
    ...
    public int popularQuestoesAnimais() {
        ...
        String somCachorroPath = "android.resource://" + mContext.getPackageName() + "/" + br.ufms.ladesp.alfabrinque.R.raw.latido;
        String somGatoPath = "android.resource://" + mContext.getPackageName() + "/" + br.ufms.ladesp.alfabrinque.R.raw.gato;
        String somJacarePath = "android.resource://" + mContext.getPackageName() + "/" + br.ufms.ladesp.alfabrinque.R.raw.crocodilo;
        String somLeaoPath = "android.resource://" + mContext.getPackageName() + "/" + br.ufms.ladesp.alfabrinque.R.raw.leao;
        String somVacaPath = "android.resource://" + mContext.getPackageName() + "/" + br.ufms.ladesp.alfabrinque.R.raw.vaca;
