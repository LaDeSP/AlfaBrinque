...
import br.ufms.ladesp.alfabrinque.pojo.EstadoUsuario;
import br.ufms.ladesp.alfabrinque.pojo.HistoricoUsuario;
import br.ufms.ladesp.alfabrinque.pojo.Questao;
import br.ufms.ladesp.alfabrinque.ui.QuestoesRespondidasSucesso;
import br.ufms.ladesp.alfabrinque.util.Shuffle;
import br.ufms.ladesp.alfabrinque.util.UsuarioEscolhido;
...
public class ResponderQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(br.ufms.ladesp.alfabrinque.R.layout.activity_responder_quiz);

        UtilitarioUI.hideSystemUI(getWindow());

        dao = AppDAO.newInstance(this);

        ll = (LinearLayout) findViewById(br.ufms.ladesp.alfabrinque.R.id.quiz_layout);
        dropLayout = (LinearLayout) findViewById(br.ufms.ladesp.alfabrinque.R.id.drop_layout);
        btnResponder = (ImageButton) findViewById(br.ufms.ladesp.alfabrinque.R.id.btnResponder);
        btnApagar = (ImageButton) findViewById(br.ufms.ladesp.alfabrinque.R.id.btn_apagar);

        quizImage = (ImageView) findViewById(br.ufms.ladesp.alfabrinque.R.id.quiz_image);
        rootLayoutImg = (LinearLayout) findViewById(br.ufms.ladesp.alfabrinque.R.id.root_layout);
        ...
        isTablet = getResources().getBoolean(br.ufms.ladesp.alfabrinque.R.bool.tablet);
        ...
        if (categoria != -1) {
            ...
            if (categoria == 1) {
                rootLayoutImg.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.teste_grama3);
            } else if (categoria == 2) {
                rootLayoutImg.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.picnic_novo);
            } else if (categoria == 3) {
                rootLayoutImg.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.fundo_objetos);
            }
    ...
    private void carregarQuestao(final int categoria, int ordem) {
        if (btnResponder != null) {
            if (isTablet) {
                btnResponder.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_play_circle_filled_black_24dp_quiz_tablet_disabled);
            } else {
                btnResponder.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_play_circle_filled_black_24dp_quiz_disabled);
            }
        ...
        for (int i = 0; i < length; i++) {
            ...
            rootTextView.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_shape);
            rootTextView.setTextColor(ContextCompat.getColor(this, br.ufms.ladesp.alfabrinque.R.color.textViewTextColor));
    ...
    private void initDropTiles() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            linearLayout.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_tiles_shape);
    ...
    private void mostrarRespostaCerta() {
        ...
        MediaPlayer mp = MediaPlayer.create(ResponderQuiz.this, br.ufms.ladesp.alfabrinque.R.raw.right_answer);
        mp.start();
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mp) {
                mp.release();
        ...
        result.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_check_black_24dp);
    ...
    private void mostrarRespostaErrada() {
        ...
        MediaPlayer mp = MediaPlayer.create(ResponderQuiz.this, br.ufms.ladesp.alfabrinque.R.raw.buzzer2);
        mp.start();
        mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            public void onCompletion(MediaPlayer mp) {
                mp.release();
        ...
        result.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_close_black_24dp);
    ...
    public void onBackPressed() {
        ...
        new AlertDialog.Builder(this)
                .setTitle(getString(br.ufms.ladesp.alfabrinque.R.string.txt_dialog_encerrar_quiz_title))
                .setMessage(getString(br.ufms.ladesp.alfabrinque.R.string.txt_dialog_encerrar_quiz_text))
    ...
    public void apagarLetras(View view) {
        for (int i = 0; i < dropLayout.getChildCount(); i++) {
            ...
            if (v != null) {
                ...
                tv.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_shape);
                tv.setTextColor(ContextCompat.getColor(this, br.ufms.ladesp.alfabrinque.R.color.textViewTextColor));
    ...
    private final class MyTouchListener implements View.OnTouchListener {
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                MediaPlayer mp = MediaPlayer.create(ResponderQuiz.this, br.ufms.ladesp.alfabrinque.R.raw.start_drag_sound);
                mp.start();
                mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    public void onCompletion(MediaPlayer mp) {
                        mp.release();
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (action) {
                ...
                case DragEvent.ACTION_DRAG_ENTERED:
                    v.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_tiles_shape_enter);
                    break;
                case DragEvent.ACTION_DRAG_EXITED:
                    v.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_tiles_shape);
                    break;
...
//                    }
                    ...
                    if (layout != null) {
                        if (layout.getChildCount() == 0) {
                            ...
                            MediaPlayer mp = MediaPlayer.create(ResponderQuiz.this, br.ufms.ladesp.alfabrinque.R.raw.end_drag_sound);
                            mp.start();
                            mp.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                public void onCompletion(MediaPlayer mp) {
                                    mp.release();
                            ...
                            view.setBackgroundResource(br.ufms.ladesp.alfabrinque.R.drawable.word_shape);
                            ll.addView(view);
                        }
                    }
                    ...
                    if (containerChildCount != 0) {
                        ...
                        if (isTablet) {
                            btnResponder.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_play_circle_filled_black_24dp_quiz_tablet);
                        } else {
                            btnResponder.setImageResource(br.ufms.ladesp.alfabrinque.R.drawable.ic_play_circle_filled_black_24dp_quiz);
                        }
